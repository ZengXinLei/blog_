    ...
    <div style="text-align:center" class="container">
      <header style="padding-top:6px;" class="codrops-header">
        <h1>{{title}}
          ...
          <span v-if="flag" style="font-size:14px;font-weight:500;margin-top:40px;">
            —— 欢迎你！第 <font style="font-size:34px;">{{tourist.tName.split("_")[1]}}</font> 位访问的游客 ——
          </span>
        </h1>
      </header>
    <div class="grid">
      <figure v-for="figure in figureList" :class="figure.style">
          ...
          <figcaption>
              ...
              <template  v-if="figure.href===''">
                <router-link :to="figure.router">View more</router-link>
              </template>
            <template v-else>
              <a :href="figure.href" target="view">View more</a>
            </template>
...
export default {
  ...
  data () {
    return {
      ...
      descList: ['一名即将毕业的菜鸟小码农，热爱生活，喜欢设计，', '严谨，强迫症，爱玩，爱电影', '这是我的地盘，分享技术经验，生活琐事，见闻趣事。']
    }
  },
  methods: {
