      ...
      <div class="content-container-item">
        <header class="contact-header">
          <div class="tangyidaImag">
            <img class="tangyida" src="https://s1.ax1x.com/2020/05/19/YIKHwn.jpg"/>
          </div>
          <div class="name-introduce">
            <h1>我是梦尘</h1>
            <h5>一名99年生的fw<font style="font-weight:200"> <(￣︶￣)></font>。</h5><br/>
            <div style="position:relative;" class="contact-tools">
              <div v-show="wechatFlag" style="position:absolute;top:-100%;left:0px;right:0px;">
                <img @mouseleave="wechatFlag=false" width="320px" src="../../assets/image/WeChart.jpg"/>
              </div>
              <a @mouseenter="wechatFlag=true" href="javascript:;" style="color:#00ca0e;">
                <i class="fa fa-wechat fa-2x" aria-hidden="true"></i>
              </a>
              <a href="https://github.com/ZengXinLei" target="view_window" style="color:#222;margin-left: 10px;">
...
<!--              </a>-->
      ...
      <div id="leave_message" class="content-container-item">
        ...
        <br/>
        <div class="comment">
          <blog-comment v-on:submit-comment="subLeaveMessage">
          </blog-comment>
          <br/><br/>
          <template v-if="flag1">
